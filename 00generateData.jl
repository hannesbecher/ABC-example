...
# ╔═╡ 0b71686f-7025-4878-a7b3-a3bde5d85f4f
using Plots

# ╔═╡ b1385638-b4d3-4c7f-9a4f-10d11a560c6c
using DelimitedFiles

# ╔═╡ dccbb9de-bd9a-426d-8e7d-f3dfd3a37be1
using Distributions

# ╔═╡ dd1000ea-03d7-11ee-04a6-db975b4130b2
md"""
# Generate data for ABC
"""

# ╔═╡ e442599f-d003-4430-ba1b-deca3f47a3d8
pwd()

# ╔═╡ 39d36441-e956-48aa-ae47-9e04a5cf2b2a
begin
	α=2
	β=4
	n=100
	xVals=rand(n) .* 100 .- 50
	yVals= (α .+ β .* xVals) + rand(Normal(0,10), n)
end

# ╔═╡ 621997e3-7c31-4101-b686-dbdcb2e730cc
scatter(xVals, yVals)

# ╔═╡ 112da779-5edf-4695-8caa-254ffafc8d4e
writedlm("dat.csv", hcat(xVals, yVals), ",")
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "def181dbb4ecfff6cc7c07f54d3f15ef04f2b2d2"
